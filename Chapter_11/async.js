...
fifteen.then(value => console.log(`Twice is ${value * 2}`));
...
let prom = new Promise((_, reject) => reject(new Error("Fail")))
...
// async function chicks(nest, year) { //Broken because += adds to current value of list at time it started executing
//     let list = "";
